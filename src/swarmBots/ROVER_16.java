...
public class ROVER_16 {
	...
	private void run() throws IOException, InterruptedException {
		...
		while (true) {
			...
			System.out.println("ROVER_16 currentLoc at start: " + currentLoc);
			...
			//System.out.println("ROVER_16 equipment list results drive " + equipment.get(0));
			System.out.println("ROVER_16 equipment list results " + equipment + "\n");
			
	

			// ***** do a SCAN *****
			//System.out.println("ROVER_16 sending SCAN request");
			this.doScan();
			...
			if (blocked) {
				...
				if (goingEast) {
					...
					if (scanMapTiles[centerIndex][centerIndex +5].getHasRover() 
					...
					if (scanMapTiles[centerIndex][centerIndex -1].getHasRover() 
						...
						// request to server to move
						out.println("MOVE W");
						System.out.println("ROVER_16 request move W");
					}
