...
public class Rover_basic_mvmnt 
{
	...
	public Rover_basic_mvmnt(String serverAddress) 
	{
		// constructor
		System.out.println("ROVER_16 rover object constructed");
		rovername = "ROVER_16";
	...
	*/
	...
	public static void main(String[] args) throws Exception {
		Rover_basic_mvmnt client = new Rover_basic_mvmnt();
		client.run();
	}
}